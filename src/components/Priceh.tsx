  ...
  return (
    <section className="bg-white lg:px-22 px-4 2xl:px-30 md:mb-18">
      <div className="container mx-auto flex flex-col lg:flex-row items-center lg:justify-between justify-center">
        {/* Left side */}
        <div className="lg:flex-1 text-center md:text-left lg:mb-10 mt-10 mb-5 md:mb-0 lg:mt-19">
          <h1 className="text-[30px] md:text-5xl 2xl:text-6xl font-black text-[#0056D2] lg:tracking-tight lg:leading-15 2xl:mb-8 lg:mb-11 lg:mr-10 mb-4 leading-11 tracking-normal mx-3 lg:mx-0 2xl:mr-35 2xl:leading-20">
